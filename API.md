...
###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.Editorconfig.isConstruct.parameter.x"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.Eslint.isConstruct.parameter.x"></a>
...
##### `toString` <a name="toString" id="@skyrpex/wingen.NodeProject.toString"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@skyrpex/wingen.NodeProject.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#@skyrpex/wingen.NodeProject.isProject">isProject</a></code> | Test whether the given construct is a project. |
| <code><a href="#@skyrpex/wingen.NodeProject.of">of</a></code> | Find the closest ancestor project for given construct. |

---

##### `isConstruct` <a name="isConstruct" id="@skyrpex/wingen.NodeProject.isConstruct"></a>

```typescript
import { NodeProject } from '@skyrpex/wingen'

NodeProject.isConstruct(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.NodeProject.isConstruct.parameter.x"></a>
...
##### `isProject` <a name="isProject" id="@skyrpex/wingen.NodeProject.isProject"></a>

```typescript
import { NodeProject } from '@skyrpex/wingen'

NodeProject.isProject(x: any)
```

Test whether the given construct is a project.

###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.NodeProject.isProject.parameter.x"></a>

- *Type:* any

---

##### `of` <a name="of" id="@skyrpex/wingen.NodeProject.of"></a>

```typescript
import { NodeProject } from '@skyrpex/wingen'

NodeProject.of(construct: IConstruct)
```
...
###### `construct`<sup>Required</sup> <a name="construct" id="@skyrpex/wingen.NodeProject.of.parameter.construct"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@skyrpex/wingen.NodeProject.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
...
##### `node`<sup>Required</sup> <a name="node" id="@skyrpex/wingen.NodeProject.property.node"></a>
...
##### `toString` <a name="toString" id="@skyrpex/wingen.Tsup.toString"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@skyrpex/wingen.Tsup.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#@skyrpex/wingen.Tsup.isComponent">isComponent</a></code> | Test whether the given construct is a component. |

---

##### `isConstruct` <a name="isConstruct" id="@skyrpex/wingen.Tsup.isConstruct"></a>

```typescript
import { Tsup } from '@skyrpex/wingen'

Tsup.isConstruct(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.Tsup.isConstruct.parameter.x"></a>
...
##### `isComponent` <a name="isComponent" id="@skyrpex/wingen.Tsup.isComponent"></a>

```typescript
import { Tsup } from '@skyrpex/wingen'

Tsup.isComponent(x: any)
```

Test whether the given construct is a component.

###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.Tsup.isComponent.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@skyrpex/wingen.Tsup.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@skyrpex/wingen.Tsup.property.project">project</a></code> | <code>projen.Project</code> | *No description.* |

---

##### `node`<sup>Required</sup> <a name="node" id="@skyrpex/wingen.Tsup.property.node"></a>
...
##### `toString` <a name="toString" id="@skyrpex/wingen.Turbo.toString"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@skyrpex/wingen.Turbo.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#@skyrpex/wingen.Turbo.isComponent">isComponent</a></code> | Test whether the given construct is a component. |

---

##### `isConstruct` <a name="isConstruct" id="@skyrpex/wingen.Turbo.isConstruct"></a>

```typescript
import { Turbo } from '@skyrpex/wingen'

Turbo.isConstruct(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.Turbo.isConstruct.parameter.x"></a>
...
##### `isComponent` <a name="isComponent" id="@skyrpex/wingen.Turbo.isComponent"></a>

```typescript
import { Turbo } from '@skyrpex/wingen'

Turbo.isComponent(x: any)
```

Test whether the given construct is a component.

###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.Turbo.isComponent.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@skyrpex/wingen.Turbo.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@skyrpex/wingen.Turbo.property.project">project</a></code> | <code>projen.Project</code> | *No description.* |

---

##### `node`<sup>Required</sup> <a name="node" id="@skyrpex/wingen.Turbo.property.node"></a>
...
##### `toString` <a name="toString" id="@skyrpex/wingen.TypescriptConfig.toString"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@skyrpex/wingen.TypescriptConfig.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#@skyrpex/wingen.TypescriptConfig.isComponent">isComponent</a></code> | Test whether the given construct is a component. |

---

##### `isConstruct` <a name="isConstruct" id="@skyrpex/wingen.TypescriptConfig.isConstruct"></a>

```typescript
import { TypescriptConfig } from '@skyrpex/wingen'

TypescriptConfig.isConstruct(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.TypescriptConfig.isConstruct.parameter.x"></a>
...
##### `isComponent` <a name="isComponent" id="@skyrpex/wingen.TypescriptConfig.isComponent"></a>

```typescript
import { TypescriptConfig } from '@skyrpex/wingen'

TypescriptConfig.isComponent(x: any)
```

Test whether the given construct is a component.

###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.TypescriptConfig.isComponent.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@skyrpex/wingen.TypescriptConfig.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@skyrpex/wingen.TypescriptConfig.property.project">project</a></code> | <code>projen.Project</code> | *No description.* |

---

##### `node`<sup>Required</sup> <a name="node" id="@skyrpex/wingen.TypescriptConfig.property.node"></a>
...
##### `toString` <a name="toString" id="@skyrpex/wingen.TypescriptProject.toString"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@skyrpex/wingen.TypescriptProject.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#@skyrpex/wingen.TypescriptProject.isProject">isProject</a></code> | Test whether the given construct is a project. |
| <code><a href="#@skyrpex/wingen.TypescriptProject.of">of</a></code> | Find the closest ancestor project for given construct. |

---

##### `isConstruct` <a name="isConstruct" id="@skyrpex/wingen.TypescriptProject.isConstruct"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.TypescriptProject.isConstruct.parameter.x"></a>
...
##### `isProject` <a name="isProject" id="@skyrpex/wingen.TypescriptProject.isProject"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.TypescriptProject.isProject.parameter.x"></a>

- *Type:* any

---

##### `of` <a name="of" id="@skyrpex/wingen.TypescriptProject.of"></a>
...
###### `construct`<sup>Required</sup> <a name="construct" id="@skyrpex/wingen.TypescriptProject.of.parameter.construct"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@skyrpex/wingen.TypescriptProject.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
...
##### `node`<sup>Required</sup> <a name="node" id="@skyrpex/wingen.TypescriptProject.property.node"></a>
...
##### `toString` <a name="toString" id="@skyrpex/wingen.Vitest.toString"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@skyrpex/wingen.Vitest.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#@skyrpex/wingen.Vitest.isComponent">isComponent</a></code> | Test whether the given construct is a component. |

---

##### `isConstruct` <a name="isConstruct" id="@skyrpex/wingen.Vitest.isConstruct"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.Vitest.isConstruct.parameter.x"></a>
...
##### `isComponent` <a name="isComponent" id="@skyrpex/wingen.Vitest.isComponent"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="@skyrpex/wingen.Vitest.isComponent.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@skyrpex/wingen.Vitest.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@skyrpex/wingen.Vitest.property.project">project</a></code> | <code>projen.Project</code> | *No description.* |

---

##### `node`<sup>Required</sup> <a name="node" id="@skyrpex/wingen.Vitest.property.node"></a>
